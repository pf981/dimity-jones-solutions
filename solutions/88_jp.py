GIBBERISH = [
    # 12
    # The sides, top, and bottom of the page were neatly torn; it had apparently been ripped from a larger sheet of paper. On one side -- Dimity thought of it as the "front" -- a short love letter had been written in pencil:
    r"""
...
""".strip(),
    # 87
    # She looked at them all again, poring particularly over the what she'd supposed was gibberish that was penned on what she'd supposed was their backs. But ponder as she might, she still coul d make no sense of, for example, this, on the back of the letter that began with "Sweetheartkin", which Leland had found in the library:
    # 52: It was torn along the sides and the top, and on the back there appeared the usual neatly penned nonsense.
    r"""
...
""".strip(),
    # 87
    # Nor did she make any headway with this, on the back of the letter whose clue was found by reading the last word of each line, and which they'd found in the tapestry room:
    # 47
    # This one was torn at the sides and bottom, and again had a block of inscrutable characters penned on the back, which this time Dimity scarcely glanced at.
    r"""
...
print(len(GIBBERISH))
for i, G in enumerate(GIBBERISH):
    G = G.strip()
    L = G.splitlines()
    print(i, len(L), len(L[0]), len(G))
